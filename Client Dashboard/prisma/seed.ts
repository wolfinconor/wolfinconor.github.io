        ...
        create: [
          {
            ...
            offerTerms: {
              create: {
                ...
                closingCostEstimate: 9400,
              },
            },
            timelineSteps: {
              create: [
                { label: "Building the Offer", date: "Complete", order: 1, status: "done" },
                { label: "Offer Submitted", date: "Jul 26", order: 2, status: "done" },
                { label: "Offer Accepted", date: "Jul 28", order: 3, status: "done" },
                { label: "Inspection Period", date: "Due Aug 12", order: 4, status: "current" },
                { label: "Appraisal Period", date: "Aug 20", order: 5, status: "upcoming" },
                { label: "Financing", date: "Sep 5", order: 6, status: "upcoming" },
                { label: "Closing", date: "Sep 15", order: 7, status: "upcoming" },
              ],
            },
            nextSteps: {
              create: [
